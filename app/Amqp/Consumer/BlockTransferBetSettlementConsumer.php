...
#[Consumer(exchange: 'block_transfer', routingKey: 'transfer_bet_settlement', queue: 'block-transfer-bet-settlement', name: "BlockTransferBetSettlementConsumer", nums: 2)]
