...
class EnumType
{
    ...
    public const QUEUE_PRODUCER_BLOCK_SETTLEMENT_EXCEPTION_LIST = 'QUEUE_PRODUCER_BLOCK_SETTLEMENT_EXCEPTION_LIST'; // 区块结算异常队列
    public const QUEUE_PRODUCER_BLOCK_TRANSFER_BET_EXCEPTION_LIST = 'QUEUE_PRODUCER_BLOCK_TRANSFER_BET_EXCEPTION_LIST'; // 区块转账下注异常队列
    public const QUEUE_PRODUCER_BLOCK_TRANSFER_BET_SETTLEMENT_EXCEPTION_LIST = 'QUEUE_PRODUCER_BLOCK_TRANSFER_BET_SETTLEMENT_EXCEPTION_LIST'; // 区块转账下注结算异常队列
    public const QUEUE_PRODUCER_BLOCK_TRANSFER_EXCEPTION_LIST = 'QUEUE_PRODUCER_BLOCK_TRANSFER_EXCEPTION_LIST'; // 区块转账异常队列
}
